...
gift_stats(childList, 'gift_stats.json', 'country_stats.json')#creates two json files, each containing one of the necessary statistics
...
def compress(images):
    for image in images:
        ...
        img.save("packedgift"+image, optimize=True, quality=80) #The quality percentage can be changed. Every picture behaves differently, but we suggest a quality ranging from 30-80
